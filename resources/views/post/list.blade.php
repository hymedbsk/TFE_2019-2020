          ...
          <div class="card shadow p-3 mb-5 bg-white rounded">
            <div class="card-body">
              ...
              @if(Auth::user()->membre==1)
                <a class="card-text btn btn-success " href="{{ url('preview/'.$post->doc) }}">
                  Visionner le document</a>
                <p class="sub-card"> Ecrit par {{ $post->user->nom }} {{ $post->user->prenom }}
                  {{ $post->user->matricule }} </p>
