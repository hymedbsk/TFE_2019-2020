            ...
            <div class="row justify-content-center">
                <div class="col-md-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                            {!! Form::model($posts,['route' => ['post.update', $posts->Post_id], 'method' => 'put',
                            'class' => 'form-horizontal panel', 'enctype'=>'multipart/form-data']) !!}
                            <div class="form-group ">

                                <div class="col-md-12">
                                    <div class="form-group  ">
                                        {!! Form::text('Titre', $posts->titre, ['class' => 'form-control border
                                        border-info']) !!}
                            ...
                            <div class="form-group ">
                                <div class="row">
                                    <div class="col-md-12">
                                        <input class="form-control-file border-primary btn  btn-info" name="Nom_doc"
                                            type="file">
