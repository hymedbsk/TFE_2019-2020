                    ...
                    <div class="card">
                        <div class="card-header">
                            <p>
                                ...
                                <h3> Modifier le budget {{ $budget->nom }} </h3>
                            </p>
                        </div>
                        <div class="card-body">
                            {!! Form::model($budget,['route' => ['budget.update', Crypt::encrypt($budget->budg_id)],
                            'method' => 'put', 'class' => 'form-horizontal panel', 'enctype'=>'multipart/form-data'])
                            !!}
                            @csrf
