...
<div class="form-group">
  <label for="nom" class=" col-form-label text-md-right">Nom</label>
        ...
        <input id="nom" type="email" class="form-control @error('email') is-invalid @enderror" name="nom" value="<?php echo Auth::user()->nom ?>"  readonly>
...
<div class="form-group">
  <label for="prenom" class=" col-form-label text-md-right">Prénom</label>
        ...
        <input id="prenom" type="prenom" class="form-control @error('prenom') is-invalid @enderror" name="prenom" value="<?php echo Auth::user()->prenom ?>"  readonly>
