                    ...
                    @foreach ($users as $user)
                        ...
                        <tr>
                            ...
                            <td class="text-primary"><strong>{!! $user->email !!}</strong></td>
                     	    <td>
                              {!! Form::open(['method' => 'put', 'route' => ['user.check', $user->id]]) !!}
                              {!! Form::submit('Approuver', ['class' => 'btn btn-success btn-block', 'onclick' => 'return confirm(\'Voulez-vous raiment approuver cet utilisateur ?\')']) !!}
                              {!! Form::close() !!}
                            </td>
			    <td>
