...
Route::get('post/download/{matricule}/{file}', 'PostController@download')->middleware('verified','check', 'auth');
...
Route::get('post/admin/verification', 'PostController@getCheck')->middleware('verified','auth', 'check','membre','president');
Route::put('post/admin/verification/{post}', 'PostController@check')->name('post.check')->middleware('verified','auth', 'check','membre','president');
Route::delete('post/admin/verification/{post}', 'PostController@destroy')->name('post.supp')->middleware('verified','auth', 'check','membre','president');
Route::get('post/admin/view/{matricule}/{file}', 'PostController@visio')->middleware('verified','auth','check','membre','president');
Route::delete('user/{matricule}/{id}', 'UserController@destroy')->name('user.destroys')->middleware('verified','auth', 'check','membre','president');
